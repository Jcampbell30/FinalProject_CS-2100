...
entName.grid(row=0,column=0, columnspan=3,sticky=NSEW)
entName.focus_set()
...
btnClear.grid(row=2,column=3,columnspan=3,sticky=NSEW)
...
#Quit button
btnqt = Button(buttonFrame,text="Quit",width=16,bg='silver',font=('Calibri 18'),command=lambda:quit())
btnqt.grid(row=4,column=3,columnspan=3)
#ListBox Left Side
